  ...
  renderMarkdown(source) {
    if (!this.md) {
      ...
      this.md = new Markdown({
        ...
        langPrefix: 'language-jsx ',
        highlight: function(str, lang) {
          if (!Prism.languages.jsx) {
            throw new Error('no jsx language! ' + JSON.stringify(Object.keys(Prism.languages)));
            throw new Error('no jsx language!');
          }
    ...
    return html.replace(/<pre><code>/g, '<pre><code class="language-jsx">');
  }
